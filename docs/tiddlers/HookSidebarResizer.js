		...
		$tw.hooks.addHook('th-page-refreshed', function() {
			...
			body.addEventListener('mousemove', function() {
				...
				if ((window.innerWidth - event.clientX) < 100) {
					$tw.wiki.setText('$:/themes/tiddlywiki/vanilla/metrics/sidebarwidth', null, null, (30000 / window.innerWidth) + '%');
					$tw.wiki.setText('$:/state/sidebar', null, null, 'no');
					canResize = false;
					return;
				}
				$tw.wiki.setText('$:/themes/tiddlywiki/vanilla/metrics/sidebarwidth', null, null, widthPercent + '%');
			});
		});
	}
})();
